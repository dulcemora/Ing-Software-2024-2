    ...
    with app.app_context():
        ...
        def op4():
            ...
            while True:
                ...
                print("3. Tabla rentar")
                print("4. Salir")
                opp4 = input("Seleccione el numero que indica lo que desea hacer: ")
                    ...
                    while True:
                        ...
                        if opp3 == "1":
                            ...
                            if not idPelicula:
                                ...
                                db.session.commit()
                                print("Se ha borrado la pelicula")
                        elif opp3 == "2":
                            print("Tabla peliculas")
                    ...
                    while True:
                        ...
                        if opp3 == "1":
                            ...
                            if not idRentar:
                                ...
                                db.session.delete(idRentar)
                                db.session.commit()
                                print("Se ha borrado la renta")
                        elif opp3 == "2":
                            print("Tabla rentar")
                            rentas = Usuario.query.all()
